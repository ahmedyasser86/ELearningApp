    ...
    public partial class AddMainTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Degree = table.Column<double>(type: "float", nullable: false),
                    FullMark = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizQuestionChoice", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuizQuestionChoice_QuizQuestion_QuizQuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizQuestionChoice_QuizQuestionId",
                table: "QuizQuestionChoice",
